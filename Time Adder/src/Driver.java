...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// need some variables to store final answer
		...
		if(isNextDay){
			System.out.println("The answeris"+answerHour+":"+answerMinute+":"+answerSecond+" on the next day");
		}
		else {
			System.out.println("The answeris"+answerHour+":"+answerMinute+":"+answerSecond);
		}
